...
router.get('/inscripcion/obtenerMesasSegunAlum/:numDoc', controller.obtenerMesasSegunAlum);
router.post('/inscripcion/alumno', controller.verificarPeermisoParaRendir);
